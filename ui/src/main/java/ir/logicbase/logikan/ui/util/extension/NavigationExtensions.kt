@file:JvmName("NavigationExtensions")
...
private fun BottomNavigationView.setupDeepLinks(
    ...
    navGraphIds.forEachIndexed { index, navGraphId ->
        ...
        // Handle Intent
        val handled = navHostFragment.navController.handleDeepLink(intent)
        if (handled && selectedItemId != navHostFragment.navController.graph.id) {
